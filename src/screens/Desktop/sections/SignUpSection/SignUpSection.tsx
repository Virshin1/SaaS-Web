  ...
  return (
    <section className="relative w-full bg-white overflow-hidden">
      <div className="relative">
        ...
        {/* Decorative images */}
        <img
          className="absolute w-[342px] h-[357px] top-0 left-0 object-cover z-0 star-3d"
          alt="Decorative star graphic"
          src="/emojistar-1.png"
        />

        <img
          className="absolute w-[362px] h-[359px] top-[113px] right-0 object-cover z-0 prism-3d"
